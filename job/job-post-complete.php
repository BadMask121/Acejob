...
<div class="create-container-content" style="height:40%">
<p style="position:relative;top:45px;font-size:20px;">Job Posting Complete</p>
<div class="progress-bar">
  <div class="progress-bar-process-6">
  </div>
</div>

<p style="position:relative;left:15%;font-size:24px;margin-top:20px">You job has been been Posted successfully</p>
<p style="position:relative;left:25%;font-size:14px">More info to come but for now its just project</p>

<br>
<input type="submit" name="complete" value="Go to Dashboard" id="job-continue" style="margin-top:10px;width:120px">
  </div>
